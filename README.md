...
> **Personal fork note:** I'm primarily using this for the cheminformatics and proteomics skill sets. If you're here for the same, the most relevant skills are in `skills/cheminformatics/` and `skills/proteomics/`. The BYOK setup guide above is the easiest way to get started locally.
